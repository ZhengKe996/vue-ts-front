      ...
      <vee-form @submit="onRegister">
        ...
        <div class="pt-1 pb-3 leading-[0px] text-right">
          ...
          <div class="text-center">
            <a class="text-zinc-400 dark:text-zinc-600 hover:text-zinc-600 dark:hover:text-zinc-400 text-sm duration-400" target="__black"> 注册即同意《注册协议》 </a>
          </div>
        </div>
...
const onRegister = async () => {
  ...
  try {
    ...
    // 触发注册，携带第三方数据
    await userStore.register({ ...payload, ...route.query })
